<%@ Page Language="C#" MasterPageFile="~/PopUpMaster.Master" AutoEventWireup="true" CodeBehind="EventMeeting_popup.aspx.cs" Inherits="AnalizaProdaje.Pages.CodeList.Events.EventMeeting_popup" %>
                    ...
                    <dx:ContentControl ID="ContentControl1" runat="server">
                        <div class="section group">
                            ...
                            <div class="col span_2_of_2">
                                <dx:ASPxHtmlEditor ID="htmlOpombaSestanek" runat="server" Width="100%" CssClass="text-box-input">
                                    <SettingsValidation>
